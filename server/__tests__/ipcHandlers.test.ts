...
const { settingsEndpoints } = await import('../endpoints/definitions/settings.js');
const { agentsEndpoints } = await import('../endpoints/definitions/agents.js');
const { conversationsIpcOnlyEndpoints } = await import('../endpoints/definitions/conversations.js');
const { endpointRegistry } = await import('../endpoints/index.js');
const { registerIpcHandlers } = await import('../endpoints/generate/ipcHandlers.js');
