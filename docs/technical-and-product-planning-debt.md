...
3. **首次使用闭环**：PP-013～PP-017，先打通模型连接、首个成功任务和 Wiki 价值展示，再评价后续功能留存。
4. **产品定位与核心闭环**：PP-001～PP-005，形成一份可验收的核心路线，再决定新增功能。
5. **可靠性与体验**：TD-006、TD-009～TD-012、PP-006～PP-009。
6. **扩展和治理**：TD-013～TD-015、PP-010～PP-012，在前述基础上处理版本、文档和能力取舍。
