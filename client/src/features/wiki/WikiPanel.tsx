      ...
      {!filePath && !loading && (
        <div className="wiki-welcome">
          <div className="wiki-welcome-main">
            <div className="wiki-welcome-overline">
              <span>知识工作台</span>
              <span className="wiki-welcome-overline-code">MINT / 01</span>
            </div>
            ...
            <h2>从知识库<br /><span>开始对话</span></h2>
            <p>让每次提问都能回到可追溯的页面与证据。</p>
            ...
            <div className="wiki-welcome-capabilities" aria-label="知识库能力">
              <span><i />关键词检索</span>
              <span><i />语义检索</span>
              <span><i />来源可追溯</span>
            </div>
          </div>
          <div className="wiki-welcome-side">
