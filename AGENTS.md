...
This project is indexed by GitNexus as **mint-ai-chat** (8702 symbols, 15570 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
