...
This project is indexed by GitNexus as **mint-ai-chat** (8433 symbols, 15137 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
