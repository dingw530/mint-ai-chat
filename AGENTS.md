...
This project is indexed by GitNexus as **mint-ai-chat** (7709 symbols, 13718 relationships, 287 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
