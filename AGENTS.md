...
This project is indexed by GitNexus as **mint-ai-chat** (6047 symbols, 11010 relationships, 270 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
