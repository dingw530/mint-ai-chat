...
This project is indexed by GitNexus as **mint-ai-chat** (7086 symbols, 12520 relationships, 281 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
