...
This project is indexed by GitNexus as **mint-ai-chat** (6456 symbols, 11712 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
