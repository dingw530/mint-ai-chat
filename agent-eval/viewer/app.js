...
function render(report) {
  ...
  const qualityMetrics = [
    ...
    { label: 'Judge 通过率', value: s.judgePassAt1, description: '硬门禁通过后，语义 Judge 的通过比例' },
    { label: 'Judge 加权分', value: s.averageJudgeScore, description: '正确性、证据、完整性等语义维度加权得分' },
