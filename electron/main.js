  ...
  <style>
    * { box-sizing: border-box; }
    ...
    body {
      overflow: hidden;
      background:
        radial-gradient(circle at top left, rgba(42, 168, 125, 0.06), transparent 42%),
        linear-gradient(180deg, #f7faf8 0%, #f1f5f3 100%);
      color: #1c1c1c;
    ...
    .brand-mark {
      ...
      height: 34px;
      border-radius: 12px;
      background: linear-gradient(135deg, #2aa87d, #5b8fb9);
      box-shadow: 0 12px 30px rgba(42, 168, 125, 0.14);
      flex-shrink: 0;
    }
    .brand-text {
      display: grid;
    ...
    .brand-subtitle {
      ...
      height: 11px;
      border-radius: 999px;
      background: linear-gradient(90deg, rgba(0, 0, 0, 0.035), rgba(0, 0, 0, 0.065), rgba(0, 0, 0, 0.035));
      background-size: 200% 100%;
      animation: shimmer 1.4s linear infinite;
    }
    .nav {
    ...
    .nav-item:nth-child(1) { width: 68%; }
    .nav-item:nth-child(2) { width: 56%; }
    .nav-item:nth-child(3) { width: 64%; }
    .nav-item:nth-child(4) { width: 50%; }
    .nav-item:nth-child(5) { width: 60%; }
    .sidebar-panel {
      margin-top: auto;
      display: grid;
      gap: 12px;
    ...
    .mini-row:nth-child(1) { width: 86%; }
    .mini-row:nth-child(2) { width: 72%; }
    .mini-row:nth-child(3) { width: 64%; }
    .main {
      display: flex;
      flex-direction: column;
      gap: 18px;
    ...
    .action {
      ...
      height: 36px;
      border-radius: 999px;
      background: rgba(42, 168, 125, 0.12);
    }
    .panel {
      display: grid;
    ...
    .message:nth-child(1) { width: 72%; }
    .message:nth-child(2) { width: 88%; }
    .message:nth-child(3) { width: 64%; }
    .message:nth-child(4) { width: 82%; }
    .message:nth-child(5) { width: 58%; }
    .message:nth-child(6) { width: 76%; }
    .message:nth-child(7) { width: 68%; }
    .message:nth-child(8) { width: 84%; }
    .footer {
      margin-top: auto;
      display: flex;
      align-items: center;
...
<body>
  <div class="boot-root" aria-hidden="true">
    <div class="sidebar">
      <div class="brand">
  ...
  logger.info('Startup screen loaded');
}
...
app.whenReady().then(async () => {
  ...
  try {
    ...
    // 加载服务模块并启动 server，窗口先展示启动页避免白屏等待
